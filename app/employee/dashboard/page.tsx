...
export default function EmployeeDashboardPage() {
  ...
  const displayName = currentUser?.name || 'Alex Rivera';
  const displayRole = currentUser?.role === 'ADMIN' ? 'Administrator' : currentUser?.role === 'HR' ? 'HR Manager' : 'Software Engineer';
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs hover:shadow-md transition-shadow">
                ...
                <div className="mt-2 text-xl font-bold text-slate-900">09:02 AM</div>
              ...
              >
                ...
                <div className="mt-2 text-xl font-bold text-slate-900">
                  {salaryStructure ? formatINR(salaryStructure.netTakeHome) : '₹97,500'}
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs space-y-3">
                ...
                <div className="text-[11px] text-slate-400 pt-1">
                  Logged in as <span className="font-mono text-slate-600">{currentUser?.email || 'alex.rivera@dayflow.internal'}</span>
                </div>
              </div>
            </div>
          </div>
