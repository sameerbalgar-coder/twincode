...
async function GET(request) {
    try {
        ...
        const [employees, attendance, leaves] = await Promise.all([
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getEmployees"])({
                search,
                department
            }),
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAttendanceRecords"])(),
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getLeaveRequests"])()
        ]);
        ...
        const records = employees.map((emp)=>{
            ...
            const salaryStructure = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2f$payroll$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["calculateSalaryBreakdown"])(monthlyBase, {
            ...
            const unpaidLeaves = leaves.filter((l)=>l.employeeId === emp.id && l.leaveType === 'Unpaid Leave' && l.status === 'Approved').reduce((sum, l)=>sum + l.allocationDays, 0);
            const payableDays = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2f$payroll$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["calculatePayableDays"])(totalWorkingDays, unapprovedAbsenceDays, unpaidLeaves);
            const { proRatedGross, proRatedDeductions, netPay } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2f$payroll$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["calculateProRatedPay"])(salaryStructure.grossSalary, salaryStructure.totalDeductions, totalWorkingDays, payableDays);
            return {
                employeeId: emp.id,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1nlqjk0._.js.map