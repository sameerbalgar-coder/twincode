...
async function GET(request) {
    try {
        ...
        const leaves = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getLeaveRequests"])({
            status,
            category,
            employeeId
        });
...
async function POST(request) {
    try {
        ...
        const created = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLeaveRequest"])(body);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            data: created
        }, {
...
async function getEmployeeById(id) {
    ...
    return db.employees.find((e)=>e.id.toLowerCase() === cleanId || e.email && e.email.toLowerCase() === cleanId) || null;
}
...
async function updateEmployee(id, updates) {
    const db = ensureDatabase();
    const cleanId = id.trim().toLowerCase();
    const index = db.employees.findIndex((e)=>e.id.toLowerCase() === cleanId || e.email && e.email.toLowerCase() === cleanId);
...
async function markNotificationAsRead(id, userIdentifier) {
    const db = ensureDatabase();
...
async function markAllNotificationsAsRead(filter) {
    const db = ensureDatabase();
    let updatedCount = 0;
    if (filter) {
        const { employeeId, userId, role } = filter;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__083rgda._.js.map